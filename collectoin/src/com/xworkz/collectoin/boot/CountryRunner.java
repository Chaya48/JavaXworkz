...
public class CountryRunner {
	...
	public static void main(String[] args) {
		...
		CountryDTO dto43=new CountryDTO(43, "Croatia", "Zagreb", 4008617, true, LocalDate.of(1991, 06, 25), 5, "Catholic", "Marten (Pine Marten)", "Griffon Vulture", "Soccer", "Andrej Plenkovic");
		...
		CountryDTO dto57=new CountryDTO(57, "Estonia", "Tallinn", 1332765, true, LocalDate.of(1991, 8, 19), 15, "Christian", "Gray Wolf", "Barn Swallow", "Basketball", "Kaja Kallas");
